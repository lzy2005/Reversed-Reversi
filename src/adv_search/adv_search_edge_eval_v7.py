...
def eval(chessboard):
	...
	if depth >= 16:
		return corner_val * 25 + spec_edge_val * 12 + triv_edge_val * 4 + sum_val
	elif depth > 4:
		return corner_val * 16 + spec_edge_val * 10 + triv_edge_val * 3 + sum_val
	else:
		return corner_val * 6 + spec_edge_val * 8 + triv_edge_val * 2 + sum_val
	# spec +
